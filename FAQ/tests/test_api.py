...
def test_faq_api_returns_translated_content():
    ...
    FAQ.objects.create(
        ...
        answer_hi=(
            "कैशिंग डेटा को त्वरित पुनर्प्राप्ति के लिए "
            "संग्रहीत करता है।"
        ),
    ...
    assert (
        response_data[0]["answer"]
        == "Caching stores data for quick retrieval."
    )
    ...
    assert (
        response_data_hi[0]["question"]
        == "कैशिंग कैसे काम करती है?"
    )
    assert (
        response_data_hi[0]["answer"]
        == "कैशिंग डेटा को त्वरित पुनर्प्राप्ति के लिए संग्रहीत करता है।"
    )
    ...
    assert (
        response_data_bn[0]["question"]
        == "ক্যাশিং কীভাবে কাজ করে?"
    )
    assert (
        response_data_bn[0]["answer"]
        == "ক্যাশিং দ্রুত পুনরুদ্ধারের জন্য ডেটা সংরক্ষণ করে।"
    )
